...
def montage_data(data, template_file=DEFAULT_template, outdir = DEFAULT_dir, indir=DEFAULT_dir, output_file=DEFAULT_output,
                 pdf_file=DEFAULT_pdf, 
                 channel_file=DEFAULT_channel, signal=DEFAULT_signal):
    ...
    out = save_to_image(data,template_file=template_file, output_file=output_file)
